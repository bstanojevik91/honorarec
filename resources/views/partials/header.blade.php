        ...
        <div class="md:hidden">
            <div class="grid grid-cols-[3rem_1fr_3rem] items-center gap-3">
                <details class="relative">
                    ...
                    <div class="absolute left-0 top-full mt-3 w-[min(21rem,calc(100vw-2rem))] rounded-[1.4rem] border border-white/10 bg-slate-950/92 p-2 text-sm font-medium text-slate-100 shadow-[0_24px_50px_-28px_rgba(0,0,0,0.85)] backdrop-blur">
                ...
                <a href="{{ route('home') }}" class="inline-flex min-w-0 items-center justify-center gap-2 text-white">
                    <span class="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-white/15 bg-white/10 text-base font-bold shadow-lg shadow-slate-950/20 backdrop-blur">
                        H
                    </span>
                    <span class="truncate text-base font-semibold tracking-wide">Хонорарец</span>
                </a>

                <a href="{{ route('employer.login') }}" class="inline-flex h-12 w-12 items-center justify-center justify-self-end rounded-full border border-white/15 bg-emerald-600 text-white shadow-lg shadow-emerald-950/30 ring-1 ring-white/10 transition hover:bg-emerald-500" aria-label="Најава за компании">
                    <svg viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5">
