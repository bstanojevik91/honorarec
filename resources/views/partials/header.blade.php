<header class="absolute inset-x-0 top-0 z-20">
    <div class="mx-auto max-w-7xl px-4 py-4 sm:px-6 sm:py-5 lg:px-8">
        <div class="relative flex items-center justify-center md:justify-between">
            <details class="absolute left-0 top-1/2 -translate-y-1/2 md:hidden">
            ...
            <a href="{{ route('employer.login') }}" class="absolute right-0 top-1/2 inline-flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-white/15 bg-emerald-600 text-white shadow-lg shadow-emerald-950/30 transition hover:bg-emerald-500 md:hidden" aria-label="Најава за компании">
                <svg viewBox="0 0 20 20" fill="currentColor" class="h-5 w-5">
