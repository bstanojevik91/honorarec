<article class="group flex h-full flex-col overflow-hidden rounded-[1.4rem] border border-slate-200/85 bg-white shadow-[0_16px_36px_-30px_rgba(15,23,42,0.18)] transition duration-300 hover:shadow-[0_22px_40px_-30px_rgba(15,23,42,0.22)] sm:rounded-[1.5rem] md:hover:-translate-y-1">
    <a href="{{ route('blog.show', $post['slug']) }}" class="block overflow-hidden">
        <img src="{{ $post['image'] }}" alt="{{ $post['title'] }}" class="h-40 w-full object-cover transition duration-500 group-hover:scale-[1.03] sm:h-44">
    </a>
    ...
    <div class="flex flex-1 flex-col p-4 sm:p-5">
        ...
        <h3 class="mt-3 text-lg font-bold leading-snug text-slate-900 sm:text-[1.2rem]">
