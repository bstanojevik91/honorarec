...
@section('content')
        ...
        <section class="relative mx-auto max-w-7xl px-4 pb-16 pt-36 sm:px-6 lg:px-8 lg:pb-20 lg:pt-44">
            <div class="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
                <div class="max-w-4xl text-white">
                    ...
                    <h1 class="mt-5 text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-[3.5rem] lg:leading-[1.04]">Совети, новости и корисни статии за работа и ангажмани</h1>
                ...
                @if ($featuredPost)
                    <a href="{{ route('blog.show', $featuredPost['slug']) }}" class="group overflow-hidden rounded-[2rem] border border-white/10 bg-white/10 shadow-[0_24px_70px_-36px_rgba(15,23,42,0.85)] backdrop-blur">
                        <img src="{{ $featuredPost['image'] }}" alt="{{ $featuredPost['title'] }}" class="h-72 w-full object-cover transition duration-500 group-hover:scale-[1.03]">
                        <div class="p-6 text-white">
                            <p class="text-xs font-semibold uppercase tracking-[0.18em] text-emerald-300">Издвоена статија</p>
                            <h2 class="mt-3 text-2xl font-bold leading-tight">{{ $featuredPost['title'] }}</h2>
    ...
    <main class="bg-stone-50">
        <section class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            <div class="mb-8">
                <h2 class="text-3xl font-bold tracking-tight text-slate-900 sm:text-[2rem]">Сите статии</h2>
