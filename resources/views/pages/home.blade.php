                ...
                <div class="space-y-4">
                    ...
                    <div class="grid gap-3.5 lg:grid-cols-[1.55fr_0.9fr_0.9fr_auto]">
                        ...
                        @include('partials.location-filter', [
                            ...
                            'triggerClass' => 'hero-search-field flex h-[3.55rem] w-full min-w-0 items-center justify-between gap-3 overflow-hidden rounded-[1.25rem] border border-slate-200 bg-slate-50/90 pl-4 pr-4 text-sm font-medium text-slate-900 outline-none transition hover:bg-white focus:border-emerald-500 focus:bg-white focus:ring-0',
