@extends('admin.layouts.app', [
    ...
    'pageDescription' => 'Целосен преглед на кандидатот и поднесената апликација.',
])
...
@section('content')
    <div class="grid gap-6 lg:grid-cols-[1.2fr_0.8fr]">
        ...
        <div class="rounded-[1.6rem] bg-white p-8 shadow-[0_20px_45px_-34px_rgba(15,23,42,0.2)]">
            ...
            <div class="mt-6 space-y-5">
                ...
                <div>
                    ...
                    @if ($application->cv_path)
                        <a href="{{ route('admin.applications.cv', $application) }}" class="mt-2 inline-flex text-sm font-semibold text-emerald-700 hover:text-emerald-600">Отвори CV</a>
                    @else
            ...
            <div class="mt-8">
                <a href="{{ route('admin.applications.index') }}" class="inline-flex items-center justify-center rounded-full border border-slate-200 px-7 py-3 text-sm font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50">
                    Назад кон апликации
                </a>
            </div>
        </div>
